...
void u8g2_home_frame(uint8_t a) {
  u8g2.drawStr(HOURS_X, HOURS_Y, "06");
  u8g2.drawStr(MINUTES_X, MINUTES_Y, "53");
  u8g2.setFont(u8g2_font_squeezed_b7_tr);
  u8g2.drawStr(DATE_X, DATE_Y, "SAT, 12/03");
  u8g2.setFont(u8g2_font_battery19_tn);
  u8g2.setFontDirection(1);
  u8g2.drawStr(64, 75,"2");
  u8g2.setFont(u8g2_font_squeezed_b7_tr);
  u8g2.setFontDirection(0);
